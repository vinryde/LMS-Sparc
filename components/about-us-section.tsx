    ...
    >
      ...
      >
        <motion.div className="flex flex-col items-center mb-6" variants={itemVariants}>
          ...
          <h2 className="text-4xl md:text-5xl font-normal mb-4 text-center">Energy Education</h2>
          <motion.div
...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    <motion.div
      className="bg-card/50 backdrop-blur-sm p-6 rounded-xl border border-border flex flex-col items-center text-center group hover:bg-card transition-colors duration-300"
      variants={{
    ...
    >
      <motion.div
        className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4 text-[#88734C] group-hover:bg-[#88734C]/20 transition-colors duration-300"
